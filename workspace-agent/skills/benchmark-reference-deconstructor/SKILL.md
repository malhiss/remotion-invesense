---
name: benchmark-reference-deconstructor
description: Use to compare a proposed route against Family B/C benchmark grammar and Family A motion-energy references without copying creator layouts.
---
...
1. Classify each reference as source, benchmark, material, motion, style, or negative example.
2. Extract behavior logic rather than layout shell.
3. Record what improves Family B/C light editorial proof.
4. Use Family A only for asset motion, pacing, and event clarity.
5. Block references that change claims or tempt direct copying.
