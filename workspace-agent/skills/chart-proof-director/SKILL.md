---
name: chart-proof-director
description: Use when a source chart, SVG, table, graph, benchmark line, or stat card may become animated proof in a Family B/C reel.
---
...
1. Confirm the chart is readable, central to proof, and source-locked.
2. Choose whether animation improves understanding without weakening the physical mechanism.
3. Require native Remotion/SVG reconstruction for proof-critical SVG charts.
4. Attach proof labels to bar/line/marker events, never before those events occur.
5. Block charts that require invented values, dates, units, labels, or ordering.
