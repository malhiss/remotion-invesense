---
name: styleframe-visual-target-director
description: Use to require visual references, asset boards, and approved styleframes before complex Codex handoff.
---
...
1. Define what each reference teaches: form, material, layout, behavior, pacing, or negative example.
2. Require approved target stills or detailed styleframe direction for complex reels.
3. State what may be adapted and what must not be copied.
4. Block Codex handoff if visual targets are missing or too vague.
5. Preserve Family B/C light editorial grammar unless a dark beat is explicitly approved.
