---
name: brand-label-silent-reviewer
description: Use to review Invesense fit, light editorial taste, label budget, typography, mobile-safe zones, and silent-feed clarity.
---
...
1. Check that text is large, direct, and attached to visual events.
2. Reject detached proof cards and labels floating over unrelated motion.
3. Preserve source labels and caveats while keeping visual hierarchy clean.
4. Check the no-label test: object behavior should communicate the mechanism first.
5. Keep Family B/C light background grammar as default.
