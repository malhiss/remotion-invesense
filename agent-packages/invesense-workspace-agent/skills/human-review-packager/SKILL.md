---
name: human-review-packager
description: Use to turn deep packet work into a decision-friendly human review document with route cards, evidence tables, visual targets, and exact approval choices.
---
...
1. Summarize only what changes the next decision.
2. Separate facts, creative recommendation, visual references, and implementation readiness.
3. Surface risks: source gaps, chart distortion, weak proof birth, weak residue, Lottie misuse.
4. Name the exact next human approval needed.
5. Keep Codex blocked until the required approvals are explicit.
