---
name: mechanism-story-diagnostician
description: Use to turn financial topics into force, constraint, state change, proof consequence, and physical mechanism before route ideation.
---
...
1. State the finance story without visual language first.
2. Map the story to a force acting on a constraint and causing a visible state change.
3. Reject keyword-led visuals that do not explain the mechanism.
4. Choose mechanism families from references only as options, not as route approval.
5. Define what the viewer should understand before reading every label.
