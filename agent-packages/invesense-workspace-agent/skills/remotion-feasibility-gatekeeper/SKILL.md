---
name: remotion-feasibility-gatekeeper
description: Use to map approved creative plans to deterministic Remotion capabilities, allowed packages, SVG/chart paths, Lottie rules, and review tooling.
---
...
1. Prefer native Remotion/SVG for proof-critical charts and shape/path animation.
2. Use Lottie only through approved local JSON and QA frames.
3. Gate 3D unless it clarifies faster than 2D.
4. Require deterministic frame-based animation and source-safe props.
5. Block final MP4 until stills/contact sheets pass.
